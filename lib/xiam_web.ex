defmodule XIAMWeb do
  ...
  def static_paths, do: ~w(assets fonts images swagger favicon.ico robots.txt)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: XIAMWeb.Router,
        statics: XIAMWeb.static_paths()
    end
  end
