...
start_node() {
    ...
    export ELIXIR_ERL_OPTIONS="-kernel inet_dist_listen_min 9100 inet_dist_listen_max 9102"
...
# Export the cookie for the config generation
...
start_node 1 && sleep 5 && \
start_node 2 && sleep 5 && \
start_node 3
